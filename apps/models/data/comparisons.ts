...
export const comparisons: ComparisonEntity[] = [
  ...
  },
  {
    ...
    verified: true,
    verificationStatus: "verified",
    lastCheckedAt: "2026-05-21T18:00:00.000Z",
    updatedDate: "2026-05-21",
    useCases: [
    ...
    limitations: [
      "Mistral Large 3's max output tokens and explicit modality channel list are not stated on the spec card — those fields remain null on its model record.",
      "Pricing units are directly comparable for base input/output between the two sides; Anthropic publishes additional cache/batch rows that Mistral's spec card does not.",
      "WebmasterID Models does not declare a winner; readers should compare verified facts against their own workload.",
    ],
    declaresWinner: false,
  },
  {
    id: "comparison-mistral-large-3-vs-gemini-2-5-pro",
    slug: "mistral-large-3-vs-gemini-2-5-pro",
    name: "Mistral Large 3 vs Gemini 2.5 Pro",
    description:
    ...
    updatedDate: "2026-05-21",
    useCases: [
      "Long-context document analysis (Gemini 2.5 Pro 1,048,576 tokens; Mistral Large 3 256k tokens)",
      "Open-weights European serving (Mistral) versus closed-weights US-hosted (Google)",
      "Multimodal understanding — Gemini publishes audio/image/video/text/PDF inputs explicitly; Mistral's card describes the model as multimodal without enumerating channels",
    ],
    limitations: [
      "Mistral Large 3's max output and explicit modality channels are not stated on the vendor spec card — those fields render unverified.",
      "Gemini publishes prompt-size tier pricing (≤200k vs >200k) and per-hour cache storage; Mistral's pricing surface is base input/output only on the spec card. Direct unit-by-unit normalisation is not meaningful.",
      "WebmasterID Models does not declare a winner; readers should compare verified facts against their own workload.",
    ],
    declaresWinner: false,
  },
  {
    id: "comparison-deepseek-v4-pro-vs-mistral-large-3",
    slug: "deepseek-v4-pro-vs-mistral-large-3",
    name: "DeepSeek V4 Pro vs Mistral Large 3",
    description:
    ...
    updatedDate: "2026-05-21",
    useCases: [
      "Cost-sensitive reasoning workloads (DeepSeek v4-pro runs a 75% promotional discount window until 2026/05/31; Mistral Large 3 base input rate is $0.50/M)",
      "Open-weights (Mistral) versus DeepSeek's hosted-only model surface",
      "Million-token-class context — DeepSeek V4 Pro 1M tokens; Mistral Large 3 256k tokens",
    ],
    limitations: [
      "DeepSeek splits input pricing into cache-miss and cache-hit rows; Mistral publishes a single input rate. Like-for-like pricing comparison requires accounting for cache behaviour.",
      "Max output tokens and explicit modality channels are not stated on either model's vendor spec card — both render unverified.",
      "WebmasterID Models does not declare a winner; readers should compare verified facts against their own workload.",
    ],
    declaresWinner: false,
  },
